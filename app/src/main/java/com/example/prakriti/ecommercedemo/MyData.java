...
public class MyData {
    private Integer id, count, menu_order, parent, image_id;
    private String name, slug, description, display, _, date_created, date_created_gmt, date_modified, date_modified_gmt, src, title, alt, self_href, collection_href;
